...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Hospital Information management </a>
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" id="Register Patient" data-toggle="list" href="#list-home" role="tab" aria-controls="home">Register Patient</a>
               ...
               <div class="col-sm-4" style="left: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <div class="tab-pane fade show " id="Register Patient" role="tabpanel" aria-labelledby="list-home-list">
